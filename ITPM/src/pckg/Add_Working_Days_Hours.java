...
public class Add_Working_Days_Hours {
	...
	private void initialize() {
		...
		lblNewLabel_1.setBounds(31, 56, 141, 14);
		...
		lblNewLabel_2.setBounds(28, 99, 144, 14);
		...
		Checkbox checkbox_4 = new Checkbox("Thursday");
		...
		lblNewLabel_3.setBounds(28, 310, 144, 14);
		frame.getContentPane().add(lblNewLabel_3);
		
		JSpinner spinner = new JSpinner();
		spinner.setBounds(345, 307, 143, 20);
		frame.getContentPane().add(spinner);
		
		JSpinner spinner_1 = new JSpinner();
		spinner_1.setBackground(new Color(127, 255, 212));
		spinner_1.setBounds(182, 307, 127, 20);
		frame.getContentPane().add(spinner_1);
		
		JLabel lblNewLabel_4 = new JLabel("Select Time Slot");
		lblNewLabel_4.setBounds(28, 367, 144, 14);
